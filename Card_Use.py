...
class  Card_Use:
    def __init__(self,root,isTKroot = True):
        ...
        Fun.SetControlPlace(uiName,'Button_4',620,110,100,28)
        ...
        Fun.SetControlPlace(uiName,'Button_3',335,110,100,28)
        Button_3.configure(bg = "#00ffff")
        Button_3.configure(command=lambda:Card_Use_cmd.Button_3_onCommand(uiName,"Button_3"))
        Button_5 = tkinter.Button(Form_1,text="查看")
        Fun.Register(uiName,'Button_5',Button_5)
        Fun.SetControlPlace(uiName,'Button_5',905,110,100,28)
        Button_5.configure(bg = "#00ffff")
        Button_5.configure(command=lambda:Card_Use_cmd.Button_5_onCommand(uiName,"Button_5"))
