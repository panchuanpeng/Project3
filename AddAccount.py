...
class  AddAccount:
    def __init__(self,root,isTKroot = True):
        ...
        Entry_3 = tkinter.Entry(Form_1,textvariable=Entry_3_Variable, show='*')
        ...
        Entry_10 = tkinter.Entry(Form_1,textvariable=Entry_10_Variable, show='*')
        ...
        Entry_11 = tkinter.Entry(Form_1,textvariable=Entry_11_Variable, show='*')
